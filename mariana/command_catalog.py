...
COMMAND_CATALOG = (
    ...
    _spec("library", "library", CommandCategory.LIBRARY, "Inspect and maintain indexed media", forms=_forms("roots", "status", "scan", "info", "verify", "clean")),
    ...
    _spec("playlist", "playlist", CommandCategory.PLAYLISTS, "Inspect or change playlists", risk=CommandRisk.STATE_CHANGING, forms=_forms("list", "create", "show", "add", "remove", "move", "order", "play", "queue", "import", "export", "delete", "clear")),
    _spec("album", "album", CommandCategory.PLAYLISTS, "Search or inspect albums", forms=_forms("search", "show", "tracks", "play", "queue", "save")),
    _spec("lyrics", "lyrics", CommandCategory.LYRICS, "Show or edit lyrics", risk=CommandRisk.STATE_CHANGING, forms=_forms("edit")),
