...
| Mini-player playback context | Shared validated finite-progress rendering; chapter boundaries/current-segment highlight; source-timeline preferred-region bounds; chapter/region text; live and unknown-duration suppression; read-only/no-seek regression coverage | Native visual contrast and long-title smoke remain pending | Deterministic desktop tests passed; native visual smoke pending |
