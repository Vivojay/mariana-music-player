...
| Electron/PTTY | 12 Vitest tests and 2 development PTY scenarios | 5 Windows packaged scenarios; native PTY passed on Windows, macOS ARM64, and Linux; signed multi-OS package pending | Source-native and Windows unpacked passed; signing pending |
